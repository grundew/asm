function [X, f] = integralFluidSolidFluidFocusedToPointRx(params, varargin)
...
for i = 1:nf
    ...
    w = 2*pi*f(i);
    k = w/c_F;
    fun = @(theta_z) integrand(theta_z, f(i), k, d1, d3, aTx, c_F,...
...
function I = integrand(theta_z, f, k, d1, d3, aTx, c_F,...
