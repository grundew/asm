function [V, W, k_hor, k_vert_L, debug] = fluidSolidFluidReflectionCoefficient(freq, theta_in, model, thresh)
...
for i = 1:nf
    ...
    for j = 1:nt
        ...
        if theta == 0
            ...
            [B, debug(i, j)] = fluidSolidFluidLayerMatrix(rho_solid, w, k_z_S, k_z_L, K, k_S, d, thresh);
        end
