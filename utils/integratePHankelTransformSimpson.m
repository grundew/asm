function p = integratePHankelTransformSimpson(ntheta, f, r, z, model, a, qmax, debug)
...
p = dq*((Integrand(1) + Integrand(end)) + ...
	4*sum(Integrand(2:2:end-1)) + 2*sum(Integrand(3:2:end-1)));
