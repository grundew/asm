function [V, W] =  fluidLayerReflectionCoefficientSameHS(f, theta, fluid2, fluid1, d)
...
% Reflection and transmission coefficients (equation 2.4.10 and 2.4.13 page
% 28 in Brekhovskikh)
V = (Z2.^2 - Z1.^2)./(Z1.^2 + Z2.^2 + 1i*2*Z1*Z2*cot(fi));
